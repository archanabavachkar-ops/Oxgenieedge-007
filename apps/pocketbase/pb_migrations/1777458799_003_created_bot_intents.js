...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_6273373314",
    "indexes": [],
    "listRule": "organization_id.id = @request.auth.organization_id && bot_id.organization_id.id = @request.auth.organization_id",
    "name": "bot_intents",
    "system": false,
    "type": "base",
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_6273373314");
