...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_2383489701",
    "indexes": ["CREATE INDEX idx_routing_rules_priority ON routing_rules (priority)"],
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_2383489701");
